// Issue WOTC CHL #4 Allow to specify EventListenerDeferral for X2EventListenerTemplates
...
/// ```
///
/// ## DIFFERENCES IN DIO (CHIMERA SQUAD)
///
/// This section documents any changes to this version (Chimera Squad) of CHEventListenerTemplate.uc.
/// 2/20/2021:  this is an exact copy of the one that exists in X2WOTCCommunityHighlander.
///
...
// Variable for issue WOTC CHL #869
//
