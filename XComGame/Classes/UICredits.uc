...
var localized string m_strPauseCredits; // bsg-crobinson (3.14.17) : Adding in pause button

var localized array<string> m_arrCredits;
var localized array<string> m_arrBSGCredits; //bsg-crobinson (3.16.17): Insert BSG Credits
...
simulated function UpdateNavHelp()
{
	...
	//NavHelp.AddSelectNavHelp(m_strPauseCredits); // bsg-crobinson (3.14.17) : Pause Button
	NavHelp.AddLeftHelp(Caps(class'UIReplay'.default.m_PauseReplay), class'UIUtilities_Input'.static.GetGamepadIconPrefix() $ class'UIUtilities_Input'.const.ICON_A_X);
}
