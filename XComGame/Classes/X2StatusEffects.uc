...
var config array<int> BLEEDINGOUT_TURNS;
...
var localized string DownedFriendlyName;
var localized string DownedFriendlyDesc;
var localized string DownedEffectAcquiredString;
var localized string DownedEffectTickedString;
var localized string DownedEffectLostString;
...
var localized string CapturedFriendlyName;
var localized string CapturedFriendlyDesc;
var localized string CapturedEffectAcquiredString;
var localized string CapturedEffectTickedString;
var localized string CapturedEffectLostString;
...
var name ShroudedName;
var config int SHROUDED_DEFENSE_BONUS;
var config int SHROUDED_DODGE_BONUS;
var localized string ShroudedFriendlyName;
var localized string ShroudedEffectFlyoverText;
var localized string ShroudedLostFriendlyName;
var localized string ShroudedFriendlyDesc;
var localized string ShroudedEffectAcquiredString;
var localized string ShroudedEffectTickedString;
var localized string ShroudedEffectLostString;
...
var config int SHROUDED_HIERARCHY_VALUE;
var config int BIND_HIERARCHY_VALUE;
var config int UNCONCIOUS_HIERARCHY_VALUE;
var config int CAPTURED_HIERARCHY_VALUE;
var config int DOWNED_HIERARCHY_VALUE;
var config int LIFTED_HIERARCHY_VALUE;
...
var config string ShroudedEnteredParticle_Name;
var config string ShroudedEnteredPerk_Name;
var config name ShroudedEnteredSocket_Name;
var config name ShroudedEnteredSocketsArray_Name;
...
var config string RootedParticle_Name;
var config name RootedSocket_Name;
var config name RootedSocketsArray_Name;
...
var localized string ResistedHackText;

var localized string LiftedFriendlyName;
var localized string LiftedFriendlyDesc;

var localized string RootedFriendlyName;
var localized string RootedFriendlyDesc;

var localized string ImmuneToPoisonFlyover;
var localized string ImmuneToDisorientedFlyover;
var localized string ImmuneToBurningFlyover;

static function X2Effect_BleedingOut CreateBleedingOutStatusEffect(int DifficultySetting)
{
	...
	PersistentEffect.BuildPersistentEffect(default.BLEEDINGOUT_TURNS[DifficultySetting],,,,eWatchRule_UnitTurnBegin);
	PersistentEffect.SetDisplayInfo(ePerkBuff_Penalty, default.BleedingOutFriendlyName, default.BleedingOutFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_BleedingOut, true, class'UIUtilities_Image'.const.UnitStatus_BleedingOut, , true);
...
static function BleedingOutVisualizationTicked(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddEffectMessageToTrack(
		...
		eUIState_Bad, , MessageAction);
	if (MessageAction != None)
	{
		MessageAction.bDontPlaySoundEvent = false;
		MessageAction.bPlayBleedingOutTickedSound = true;
	}
...
static function RuptureVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata)
{
	...
	AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), default.RupturedFriendlyName, 'Ruptured', eColor_Bad, , 1.5f);
	AddEffectMessageToTrack(
		ActionMetadata,
		default.RupturedEffectAcquiredString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.BleedingTitle,
		class'UIUtilities_Image'.const.UnitStatus_Bleeding,
		eUIState_Bad);
	UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
}
...
static function X2Effect_Burning CreateBurningStatusEffect(int DamagePerTick, int DamageSpreadPerTick)
{
	...
	BurningEffect.BuildPersistentEffect(default.BURNING_TURNS,, false,,eWatchRule_UnitTurnBegin);
	BurningEffect.SetDisplayInfo(ePerkBuff_Penalty, default.BurningFriendlyName, default.BurningFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Burning, true, class'UIUtilities_Image'.const.UnitStatus_Burning);
	...
	BurningEffect.bRemoveWhenTargetUnconscious = true;
...
static function X2Effect_RemoveEffects CreateBurningRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;

	// remove other tile effects
	RemoveEffects = new class'X2Effect_RemoveEffects';
	RemoveEffects.EffectNamesToRemove.AddItem(default.AcidBurningName);
	RemoveEffects.EffectNamesToRemove.AddItem(default.PoisonedName);
	RemoveEffects.EffectNamesToRemove.AddItem(default.ShroudedName);
...
static function BurningVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddImmuneFlyoverVisualization( VisualizeGameState, ActionMetadata, EffectApplyResult, default.ImmuneToBurningFlyover );
	...
	AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), default.BurningFriendlyName, 'StatOnFire', eColor_Bad, class'UIUtilities_Image'.const.UnitStatus_Burning);
	AddEffectMessageToTrack(
		ActionMetadata,
...
static function X2Effect_Burning CreateAcidBurningStatusEffect(int DamagePerTick, int DamageSpreadPerTick)
{
	...
	BurningEffect.BuildPersistentEffect(default.ACID_BURNING_TURNS, , false, , eWatchRule_UnitTurnBegin);
	BurningEffect.SetDisplayInfo(ePerkBuff_Penalty, default.AcidBurningFriendlyName, default.AcidBurningFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_AcidBurning, true, class'UIUtilities_Image'.const.UnitStatus_AcidBurning);
...
static function X2Effect_RemoveEffects CreateAcidBurningRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;

	// remove other tile effects
	RemoveEffects = new class'X2Effect_RemoveEffects';
	RemoveEffects.EffectNamesToRemove.AddItem(default.BurningName);
	RemoveEffects.EffectNamesToRemove.AddItem(default.PoisonedName);
	RemoveEffects.EffectNamesToRemove.AddItem(default.ShroudedName);
...
static function AcidBurningVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	class'X2StatusEffects'.static.AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), class'X2StatusEffects'.default.AcidBurningFriendlyName, 'Acid', eColor_Bad, class'UIUtilities_Image'.const.UnitStatus_AcidBurning);
	AddEffectMessageToTrack(
		ActionMetadata,
...
static function X2Effect_PersistentStatChange CreateConfusedStatusEffect(int NumTurns)
{
	...
	PersistentStatChangeEffect.BuildPersistentEffect(NumTurns,, false,, eWatchRule_UnitTurnBegin);
	...
	PersistentStatChangeEffect.bRemoveWhenTargetUnconscious = true;
...
static function ConfusedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), default.ConfusedFriendlyName, 'StatConfused', eColor_Bad, class'UIUtilities_Image'.const.UnitStatus_Confused);
	AddEffectMessageToTrack(
		ActionMetadata,
...
static function ConfusedVisualizationTicked(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	// dead units should not be reported
	if( UnitState == None || UnitState.IsDead() || UnitState.IsIncapacitatedCapturedOrDowned() )
	{
		return;
	}
...
static function X2Effect_PersistentStatChange CreateDisorientedStatusEffect(optional bool bExcludeFriendlyToSource=false, float DelayVisualizationSec=0.0f, optional bool bIsMentalDamage = true)
{
	...
	PersistentStatChangeEffect.DuplicateResponse = eDupe_Refresh;
	PersistentStatChangeEffect.BuildPersistentEffect(default.DISORIENTED_TURNS,, false,, eWatchRule_UnitTurnBegin);
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Penalty, default.DisorientedFriendlyName, default.DisorientedFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Disoriented, true, class'UIUtilities_Image'.const.UnitStatus_Disoriented);
	...
	UnitPropCondition.ExcludeStunned = true;
	PersistentStatChangeEffect.TargetConditions.AddItem(UnitPropCondition);
...
static function DisorientedAdded(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState)
{
	...
	if (XComGameState_Unit(kNewTargetState) != None)
	{
		...
		EventManager.TriggerEvent('FeedbackLoopableEffectAdded', XComGameState_Unit(kNewTargetState), XComGameState_Unit(kNewTargetState), NewGameState);
	}	
}
...
static function DisorientedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddImmuneFlyoverVisualization( VisualizeGameState, ActionMetadata, EffectApplyResult, default.ImmuneToDisorientedFlyover );
	...
	{
		AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), default.DisorientedFriendlyName, 'StatConfused', eColor_Bad, class'UIUtilities_Image'.const.UnitStatus_Disoriented);
		AddEffectMessageToTrack(
			ActionMetadata,
			default.DisorientedEffectAcquiredString,
			VisualizeGameState.GetContext(),
			class'UIEventNoticesTactical'.default.DisorientedTitle,
			class'UIUtilities_Image'.const.UnitStatus_Disoriented,
			eUIState_Bad);
		UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
	}
}
...
static function X2Effect_MindControl CreateMindControlStatusEffect(int NumTurns, bool bRobotic=false, bool bIsInfinite=false, float DelayVisualizationSec=0.0f)
{
	...
	if(!bRobotic)
	{
		MindControlEffect.SetSourceDisplayInfo(ePerkBuff_Bonus, default.MindControlSourceFriendlyName, default.MindControlSourceFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_MindControlled);
	}
	...
	UnitPropertyCondition = new class'X2Condition_UnitProperty';
	UnitPropertyCondition.ExcludeImmuneToMindControl = true;
	MindControlEffect.TargetConditions.AddItem(EffectCondition);
...
static function MindControlVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	// NOTE: UI feedback colors will be inverted based on target unit's team in AddEffectSoundAndFlyOverToTrack() & AddEffectMessageToTrack()
	if (EffectApplyResult != 'AA_Success')
	{
		if (kUnit != none && kUnit.IsRobotic())
		{
			AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), default.ResistedHackText, '', eColor_Good, class'UIUtilities_Image'.const.UnitStatus_MindControlled);
		}
		else
		{
	...
	if (kUnit != none)
	{
		...
		MindControlAction.MindControlledUnitRef.ObjectID = kUnit.ObjectID;
...
static function X2Effect_PersistentStatChange CreatePoisonedStatusEffect()
{
	...
	PersistentStatChangeEffect.DuplicateResponse = eDupe_Refresh;
	PersistentStatChangeEffect.BuildPersistentEffect(default.POISONED_TURNS,, false,, eWatchRule_UnitTurnBegin);
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Penalty, default.PoisonedFriendlyName, default.PoisonedFriendlyDesc, "img:///UILibrary_Common.status_poison", true, class'UIUtilities_Image'.const.UnitStatus_Poisoned);
	...
	PersistentStatChangeEffect.bShouldUseMeleeDeath = true;
...
static function X2Effect_RemoveEffects CreatePoisonedRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;
...
static function PoisonedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddImmuneFlyoverVisualization( VisualizeGameState, ActionMetadata, EffectApplyResult, default.ImmuneToPoisonFlyover );
	...
	if (ActionMetadata.StateObject_NewState.IsA('XComGameState_Unit'))
	{
		...
		AddEffectMessageToTrack(
			...
			class'UIUtilities_Image'.const.UnitStatus_Poisoned,
			eUIState_Bad);
		UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
	}
}
...
static function PoisonedVisualizationTicked(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(),"", 'EvntPoisonCloud');
}
...
static function X2Effect_Stunned CreateStunnedStatusEffect(int StunLevel, int Chance, optional bool bIsMentalDamage = true)
{
	...
	StunnedEffect.BuildPersistentEffect(1, true, true, false, eWatchRule_UnitTurnBegin);
	...
	StunnedEffect.bRemoveWhenTargetUnconscious = true;
	StunnedEffect.bCanTickEveryAction = true;
	StunnedEffect.SetDisplayInfo(ePerkBuff_Penalty, 
		default.StunnedFriendlyName, 
		default.StunnedFriendlyDesc, 
...
static function X2Effect_RemoveEffects CreateStunnedRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;
...
static function X2Effect_Downed CreateDownedStatusEffect()
{
	local X2Effect_Downed DownedEffect;
	local X2Condition_UnitProperty UnitPropCondition;
	
	DownedEffect = new class'X2Effect_Downed';
	DownedEffect.BuildPersistentEffect(1, false, true, false, eWatchRule_UnitTurnBegin);
	DownedEffect.SetDisplayInfo(ePerkBuff_Penalty, default.DownedFriendlyName, default.DownedFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Unconscious, true, class'UIUtilities_Image'.const.UnitStatus_Unconscious, , true);
	DownedEffect.bIsImpairing = true;
	DownedEffect.EffectHierarchyValue = default.DOWNED_HIERARCHY_VALUE;
	DownedEffect.EffectName = class'X2AbilityTemplateManager'.default.DownedName;
	DownedEffect.VisualizationFn = DownedVisualization;
	DownedEffect.EffectTickedVisualizationFn = DownedVisualizationTicked;
	DownedEffect.EffectRemovedVisualizationFn = DownedVisualizationRemoved;
	DownedEffect.EffectRemovedFn = DownedEffectRemoved;
	DownedEffect.bRemoveWhenTargetDies = true;
	
	UnitPropCondition = new class'X2Condition_UnitProperty';
	UnitPropCondition.ExcludeFriendlyToSource = false;
	UnitPropCondition.FailOnNonUnits = true;
	DownedEffect.TargetConditions.AddItem(UnitPropCondition);

	return DownedEffect;
}

static function DownedEffectRemoved(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState, bool bCleansed)
{
	local XComGameState_Unit UnitState;
	local X2EventManager EventManager;
	...
	UnitState = XComGameState_Unit(NewGameState.ModifyStateObject(class'XComGameState_Unit', ApplyEffectParameters.TargetStateObjectRef.ObjectID));
	EventManager.TriggerEvent('UnitDownedRemoved', UnitState, UnitState, NewGameState);
}

private static function string GetDownedFlyoverText(XComGameState_Unit TargetState, bool FirstApplication)
{
	return default.DownedFriendlyName;
}

static function DownedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local XComGameState_Unit TargetState;
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.DownedEffectAcquiredString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.DownedTitle,
		"img:///UILibrary_Common.status_stunned",
		eUIState_Bad);
	
	// Downing units during the breach shouldn't play the camera pan. We don't want to go back to world-camera
	if (!`BATTLE.GetDesc().bInBreachPhase)
	{
		AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), "", '', eColor_Bad, "", 0.0f, 1.5f, true);
	}
}

static function DownedVisualizationTicked(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local XComGameState_BaseObject CurrentState, PreviousState;
	local XComGameState_Unit UnitState, PrevUnitState;

	`XCOMHISTORY.GetCurrentAndPreviousGameStatesForObjectID(ActionMetadata.StateObject_NewState.ObjectID, PreviousState, CurrentState, eReturnType_Reference, VisualizeGameState.HistoryIndex);
	
	UnitState = XComGameState_Unit(CurrentState);
	PrevUnitState = XComGameState_Unit(PreviousState);
	if ((UnitState == None && PrevUnitState == None) || !UnitState.IsAlive())
	{
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.DownedEffectTickedString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.DownedTitle,
		"img:///UILibrary_Common.status_stunned",
		eUIState_Warning);
...
static function DownedVisualizationRemoved(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local XComGameState_Unit UnitState;
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.DownedEffectLostString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.DownedTitle,
		"img:///UILibrary_Common.status_stunned",
		eUIState_Good);
...
static function X2Effect_Persistent CreateUnconsciousStatusEffect(bool bIsMentalDamage = false, bool bNoDamageType = false)
{
	...
	PersistentEffect.bIsImpairing = true;
	PersistentEffect.SetDisplayInfo(ePerkBuff_Penalty, default.UnconsciousFriendlyName, default.UnconsciousFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Unconscious, true, class'UIUtilities_Image'.const.UnitStatus_Unconscious, , true);
...
static function UnconsciousVisualizationRemoved(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	local X2Action_Knockback KnockBackAction;				// HELIOS Issue #8 Variable
	local XComGameStateVisualizationMgr VisualizationMgr;	// HELIOS Issue #8 Variable
	local XGUnit Unit;										// HELIOS Issue #8 Variable
	...
	// Start HELIOS Issue #8
	// Re-add missing code that would allow units to properly recover from unconcious effect with little to no issues. Previously, the unit would not be animated and have some weird behaviors when this effect is cleansed (usually after bleedout).
...
static function UnconsciousEffectAdded(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState)
{
	local XComGameState_Unit UnitState;
	local X2EventManager EventManager;
	local XComGameState_Unit CaptorUnitState;

	EventManager = `XEVENTMGR;

	UnitState = XComGameState_Unit(kNewTargetState);
	CaptorUnitState = XComGameState_Unit(`XCOMHISTORY.GetGameStateForObjectID(ApplyEffectParameters.SourceStateObjectRef.ObjectID));
	if (UnitState != none)
	{
		UnitState.bUnconscious = true;
		//`XWORLD.ClearTileBlockedByUnitFlag(UnitState);
		EventManager.TriggerEvent('UnitUnconscious', CaptorUnitState, UnitState, NewGameState);

		UnitState.MakeAvailableLoot(NewGameState);
		UnitState.DropCarriedLoot(NewGameState);
	}
}
...
static function X2Effect_Persistent CreateCapturedStatusEffect(bool bIsMentalDamage = false, bool bNoDamageType = false)
{
	local X2Effect_Persistent   PersistentEffect;

	PersistentEffect = new class'X2Effect_Persistent';
	PersistentEffect.EffectName = class'X2AbilityTemplateManager'.default.CapturedName;
	PersistentEffect.DuplicateResponse = eDupe_Ignore;
	PersistentEffect.BuildPersistentEffect(1, true, false);
	PersistentEffect.bRemoveWhenTargetDies = true;
	PersistentEffect.bIsImpairing = true;
	PersistentEffect.SetDisplayInfo(ePerkBuff_Penalty, default.CapturedFriendlyName, default.CapturedFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Captured, true, class'UIUtilities_Image'.const.UnitStatus_Captured, , true);
	PersistentEffect.EffectAddedFn = CapturedEffectAdded;
	PersistentEffect.EffectRemovedFn = CapturedEffectRemoved;
	PersistentEffect.VisualizationFn = CapturedVisualization;
	PersistentEffect.EffectTickedVisualizationFn  = CapturedVisualizationTicked;
	PersistentEffect.EffectRemovedVisualizationFn = CapturedVisualizationRemoved;
	PersistentEffect.CleansedVisualizationFn = CapturedCleansedVisualization;
	PersistentEffect.EffectHierarchyValue = default.CAPTURED_HIERARCHY_VALUE;

	if (!bNoDamageType)
	{
		PersistentEffect.DamageTypes.AddItem('Capture');
		if (bIsMentalDamage)
		{
			PersistentEffect.DamageTypes.AddItem('Mental');
		}
...
static function CapturedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local bool bTriggeredByFireAction;
	...
	AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), default.CapturedFriendlyName, '', eColor_Bad, class'UIUtilities_Image'.const.UnitStatus_Captured);
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.CapturedEffectAcquiredString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.CapturedTitle,
		class'UIUtilities_Image'.const.UnitStatus_Captured,
		eUIState_Bad);
	UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
}

static function CapturedVisualizationTicked(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local XComGameState_Unit UnitState;
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.CapturedEffectTickedString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.CapturedTitle,
		class'UIUtilities_Image'.const.UnitStatus_Captured,
		eUIState_Warning);
...
static function CapturedVisualizationRemoved(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local XComGameState_Unit UnitState;
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.CapturedEffectLostString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.CapturedTitle,
		class'UIUtilities_Image'.const.UnitStatus_Captured,
		eUIState_Good);
...
static function CapturedCleansedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	CapturedVisualizationRemoved(VisualizeGameState, ActionMetadata, EffectApplyResult);
}

static function CapturedEffectAdded(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState)
{
	local XComGameState_Unit UnitState;
	local X2EventManager EventManager;
...
static function CapturedEffectRemoved(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState, bool bCleansed)
{
	local XComGameState_Unit UnitState;
	local X2EventManager EventManager;
	...
	EventManager.TriggerEvent('UnitCapturedRemoved', UnitState, UnitState, NewGameState);
}
...
static function X2Effect_PersistentStatChange CreateBoundStatusEffect(int NumTurns, bool bIsInfinite, bool bOnUnitBeingBound)
{
	...
	PersistentStatChangeEffect.DuplicateResponse = eDupe_Refresh;
	PersistentStatChangeEffect.BuildPersistentEffect(NumTurns, bIsInfinite, true,, eWatchRule_UnitTurnBegin);
	if( bOnUnitBeingBound )
	{
		PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Penalty, default.BoundFriendlyName, default.BoundFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Bound);
	}
...
static function BoundEffectAdded(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState)
{
	...
	BoundUnit.AddToUnitFloatValue(class'X2Ability_DefaultAbilitySet'.default.ImmobilizedValueName, 1, eCleanup_BeginTactical);
...
static function BountEffectRemoved(X2Effect_Persistent PersistentEffect, const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState, bool bCleansed)
{
	...
	UnitState = XComGameState_Unit(NewGameState.ModifyStateObject(class'XComGameState_Unit', ApplyEffectParameters.TargetStateObjectRef.ObjectID));
	UnitState.AddToUnitFloatValue(class'X2Ability_DefaultAbilitySet'.default.ImmobilizedValueName, -1);
	//if the UnitState was NOT the source of the bind, then remove any leftover action points.
	if( ApplyEffectParameters.SourceStateObjectRef.ObjectID != UnitState.ObjectID )
	{
...
static function BoundVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddEffectMessageToTrack(
		...
		class'UIUtilities_Image'.const.UnitStatus_Bound,
		eUIState_Bad);
	UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
}
...
static function BoundVisualizationTicked(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	local XComGameState_Effect EffectState;
	local X2Effect_Persistent	CurrEffectTemplate;
	local StateObjectReference EffectRef;
	local bool bSelfBound;
	local XComGameStateHistory				History;
	...
	foreach OldUnitState.AffectedByEffects(EffectRef)
	{
		...
		if (EffectState != none)
		{
			...
			if (CurrEffectTemplate.EffectName == class'X2AbilityTemplateManager'.default.BoundName)
			{
				if (EffectState.ApplyEffectParameters.SourceStateObjectRef.ObjectID
					== EffectState.ApplyEffectParameters.TargetStateObjectRef.ObjectID)
				{
					bSelfBound = true;
				}
			}
	...
	if (bSelfBound) //UnitState.GetMyTemplateName() == 'Viper' )
	{
		return;
	}
...
static function X2Effect_Persistent CreateMarkedEffect(int NumTurns, bool bIsInfinite)
{
	...
	PersistentEffect.DuplicateResponse = eDupe_Ignore;
	PersistentEffect.BuildPersistentEffect(NumTurns, bIsInfinite, true,, eWatchRule_UnitTurnEnd);
	PersistentEffect.SetDisplayInfo(ePerkBuff_Penalty, default.MarkedFriendlyName, default.MarkedFriendlyDesc, "img:///UILibrary_Common.status_marked", true, class'UIUtilities_Image'.const.UnitStatus_Marked);
	...
	PersistentEffect.bRemoveWhenTargetDies = true;
	PersistentEffect.bRemoveWhenTargetUnconscious = true;
...
static function MarkedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	...
	AddEffectMessageToTrack(
		...
		"img:///UILibrary_Common.status_marked",
		eUIState_Bad);
	UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
}
...
static function X2Effect_Panicked CreatePanickedStatusEffect()
{
	...
	PanickedEffect.BuildPersistentEffect(default.PANICKED_TURNS, , , , eWatchRule_UnitTurnBegin);  // Because the effect is removed at Begin turn, we add 1 to duration.
...
static function X2Effect_RemoveEffects CreatePanickedRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;
...
static function X2Effect_MutonRageBerserk CreateMutonRageBerserkStatusEffect()
{
	local X2Effect_MutonRageBerserk BerserkEffect;

	BerserkEffect = new class'X2Effect_MutonRageBerserk';
	BerserkEffect.EffectName = class'X2AbilityTemplateMAnager'.default.MutonRageBerserkName;
	BerserkEffect.BuildPersistentEffect(default.PANICKED_TURNS, , , , eWatchRule_UnitTurnBegin);
	BerserkEffect.AddPersistentStatChange(eStat_Offense, default.PANICKED_AIM_ADJUST_BERSERK);
	BerserkEffect.EffectHierarchyValue = default.PANICKED_HIERARCHY_VALUE;
	BerserkEffect.EffectAppliedEventName = 'PanickedEffectApplied';

	return BerserkEffect;
}
...
static function X2Effect_RemoveEffects CreateBerserkRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;
...
static function X2Effect_UnblockPathing CreateCivilianUnblockedStatusEffect()
{
	...
	UnblockPathingEffect.bRemoveWhenTargetUnconscious = true;
...
static function X2Effect_Persistent CreateStasisLanceEffect()
{
	...
	Effect.BuildPersistentEffect(default.STASIS_LANCE_TURNS, false, false, false, eWatchRule_UnitTurnBegin);
	Effect.bIsImpairing = true;
	Effect.SetDisplayInfo(ePerkBuff_Penalty, default.StasisLanceEffectName, default.StasisLanceEffectDesc, class'UIUtilities_Image'.const.UnitStatus_StasisLanced, true, class'UIUtilities_Image'.const.UnitStatus_StasisLanced, , true);
...
static function AddEffectSoundAndFlyOverToTrack(out VisualizationActionMetadata ActionMetadata, XComGameStateContext Context, string EffectFriendlyName, name nSoldierSpeechCue, EWidgetColor WidgetColor = eColor_Bad, string FlyOverIcon = "", optional float LookAtDuration = 0.0f, optional float DelayDuration = 0.0f, optional bool bBlockUntilFinished = false)
{
	local X2Action_PlaySoundAndFlyOver SoundAndFlyOver;
	local XComGameState_Unit UnitState;
	...
	UnitState = XComGameState_Unit(ActionMetadata.StateObject_NewState);
	bInvertColors = (UnitState.GetPreviousTeam() != eTeam_XCom && UnitState.GetPreviousTeam() != eTeam_Resistance);
	//  checking previous team here in case the unit is mind controlled.
	...
	SoundAndFlyOver.DelayDuration = DelayDuration;
	SoundAndFlyOver.BlockUntilFinished = bBlockUntilFinished;
}
...
static function AddEffectMessageToTrack(
	...
	optional out X2Action_PlayMessageBanner MessageAction)
{
	local XComGameState_Unit UnitState;
	...
	if (bInvertColors)
	{
		if (UIStyleType == eUIState_Bad)
		{
			UIStyleType = eUIState_Good;
		}
		else if (UIStyleType == eUIState_Good)
		{
			UIStyleType = eUIState_Bad;
		}
	}

	if(kTag.StrValue0 != "")
	{
		if( UIStyleType == eUIState_Warning || (!UnitState.IsMindControlled() && UnitState.GetTeam() != eTeam_XCom && UnitState.GetTeam() != eTeam_Resistance) )
		{
...
static function X2Effect_Persistent CreateBleedingStatusEffect(int NumTurns, int TickDamageAmount)
{
	...
	PersistentEffect.BuildPersistentEffect(NumTurns, , false, , eWatchRule_UnitTurnBegin);
	PersistentEffect.SetDisplayInfo(ePerkBuff_Penalty, default.BleedingFriendlyName, default.BleedingFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Bleeding, true, class'UIUtilities_Image'.const.UnitStatus_Bleeding);
...
static function X2Effect_Lifted CreateLiftedStatusEffect()
{
	local X2Effect_Lifted				LiftedEffect;
	local X2Condition_UnitProperty		UnitPropCondition;

	LiftedEffect = new class'X2Effect_Lifted';
	LiftedEffect.BuildPersistentEffect(1, false, true, false, eWatchRule_UnitTurnBegin);
	LiftedEffect.SetDisplayInfo(ePerkBuff_Penalty, default.LiftedFriendlyName, default.LiftedFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Lifted, true, class'UIUtilities_Image'.const.UnitStatus_Lifted);
	LiftedEffect.bIsImpairing = true;
	LiftedEffect.EffectHierarchyValue = default.LIFTED_HIERARCHY_VALUE;
	LiftedEffect.EffectName = class'X2AbilityTemplateManager'.default.LiftedName;
	LiftedEffect.bRemoveWhenTargetDies = true;
	LiftedEffect.bRemoveWhenTargetUnconscious = true;

	UnitPropCondition = new class'X2Condition_UnitProperty';
	UnitPropCondition.FailOnNonUnits = true;
	UnitPropCondition.ExcludeRobotic = true;
	UnitPropCondition.ExcludeTurret = true;
	LiftedEffect.TargetConditions.AddItem(UnitPropCondition);

	return LiftedEffect;
}

static function X2Effect_RemoveEffects CreateLiftedRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;

	// remove Rooted
	RemoveEffects = new class'X2Effect_RemoveEffects';
	RemoveEffects.EffectNamesToRemove.AddItem(class'X2AbilityTemplateManager'.default.RootedName);
...
static function X2Effect_Persistent CreateDoNotConsumeStatusEffect()
{
	...
	DoNotConsumeEffect.BuildPersistentEffect(1, , true, , eWatchRule_UnitTurnBegin);
	DoNotConsumeEffect.SetDisplayInfo(ePerkBuff_Passive, "", "", "", false);
	DoNotConsumeEffect.bRemoveWhenTargetDies = true;
	DoNotConsumeEffect.bRemoveWhenTargetUnconscious = true;
...
static function X2Effect_Persistent CreateUltrasonicLureTargetStatusEffect()
{
	...
	UltrasonicLureTargetEffect.SetDisplayInfo(ePerkBuff_Passive, default.UltrasonicLureFriendlyName, default.UltrasonicLureFriendlyDesc, "img:///UILibrary_Common.status_marked" );
	UltrasonicLureTargetEffect.bRemoveWhenTargetDies = true;
	UltrasonicLureTargetEffect.bRemoveWhenTargetUnconscious = true;
	return UltrasonicLureTargetEffect;
}

static function X2Effect_Rooted CreateRootedStatusEffect(int NumTurns)
{
	...
	RootedEffect = new class'X2Effect_Rooted';
	RootedEffect.BuildPersistentEffect(NumTurns, false, true, false, eWatchRule_UnitTurnBegin);
	RootedEffect.SetDisplayInfo(ePerkBuff_Penalty, default.RootedFriendlyName, default.RootedFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Rooted, true, class'UIUtilities_Image'.const.UnitStatus_Rooted);
	RootedEffect.AddPersistentStatChange(eStat_Mobility, 0, MODOP_PostMultiplication);
	RootedEffect.EffectName = class'X2AbilityTemplateManager'.default.RootedName;
	RootedEffect.bRemoveWhenTargetDies = true;
	RootedEffect.bRemoveWhenTargetUnconscious = true;
	RootedEffect.DamageTypes.AddItem('Root');
	
	if (default.RootedParticle_Name != "")
	{
		RootedEffect.VFXTemplateName = default.RootedParticle_Name;
		RootedEffect.VFXSocket = default.RootedSocket_Name;
		RootedEffect.VFXSocketsArrayName = default.RootedSocketsArray_Name;
	}

	UnitPropCondition = new class'X2Condition_UnitProperty';
	UnitPropCondition.FailOnNonUnits = true;
	UnitPropCondition.ExcludeFriendlyToSource = false;
	RootedEffect.TargetConditions.AddItem(UnitPropCondition);

	EffectCondition = new class'X2Condition_UnitEffects';
	EffectCondition.AddExcludeEffect(class'X2AbilityTemplateManager'.default.LiftedName, 'AA_UnitIsImmune');
	RootedEffect.TargetConditions.AddItem(EffectCondition);

	UnitTypeCondition = new class'X2Condition_UnitType';
	UnitTypeCondition.ExcludeTypes.AddItem('Sectopod');
	UnitTypeCondition.bUnitTemplateNameInsteadOfCharacterGroupName = true;
	RootedEffect.TargetConditions.AddItem(UnitTypeCondition);

	return RootedEffect;

}

static function X2Effect_RemoveEffects CreateRemoveAllMentalEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;
...
//Shrouded effect
static function X2Effect_Shrouded CreateShroudedStatusEffect()
{
	local X2Effect_Shrouded			ShroudedEffect;
	local X2Condition_UnitProperty	UnitPropCondition;

	ShroudedEffect = new class'X2Effect_Shrouded';
	ShroudedEffect.EffectName = default.ShroudedName;
	ShroudedEffect.SetDisplayInfo(ePerkBuff_Bonus, default.ShroudedFriendlyName, default.ShroudedFriendlyDesc, class'UIUtilities_Image'.const.UnitStatus_Shrouded, true, class'UIUtilities_Image'.const.UnitStatus_Shrouded);
	ShroudedEffect.AddPersistentStatChange(eStat_Dodge, default.SHROUDED_DODGE_BONUS);
	//ShroudedEffect.AddPersistentStatChange(eStat_Defense, default.SHROUDED_DEFENSE_BONUS);
	ShroudedEffect.VisualizationFn = ShroudedVisualization;
	ShroudedEffect.EffectRemovedVisualizationFn = ShroudedVisualizationRemoved;
	ShroudedEffect.EffectHierarchyValue = default.SHROUDED_HIERARCHY_VALUE;
	
 	if (default.ShroudedEnteredParticle_Name != "")
 	{
 		ShroudedEffect.VFXTemplateName = default.ShroudedEnteredParticle_Name;
 		ShroudedEffect.VFXSocket = default.ShroudedEnteredSocket_Name;
 		ShroudedEffect.VFXSocketsArrayName = default.ShroudedEnteredSocketsArray_Name;
 	}
	ShroudedEffect.PersistentPerkName = default.ShroudedEnteredParticle_Name;

	UnitPropCondition = new class'X2Condition_UnitProperty';
	UnitPropCondition.ExcludeFriendlyToSource = false;
	UnitPropCondition.ExcludeUnconscious = true;
	ShroudedEffect.TargetConditions.AddItem(UnitPropCondition);

	return ShroudedEffect;
}

static function X2Effect_RemoveEffects CreateShroudedRemoveEffects()
{
	local X2Effect_RemoveEffects RemoveEffects;
...
static function ShroudedVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	if (EffectApplyResult != 'AA_Success')
	{
		return;
	...
	if (ActionMetadata.StateObject_NewState.IsA('XComGameState_Unit'))
	{
		AddEffectSoundAndFlyOverToTrack(ActionMetadata, VisualizeGameState.GetContext(), `XEXPAND.ExpandString(default.ShroudedEffectFlyoverText), 'Shrouded', eColor_Good, class'UIUtilities_Image'.const.UnitStatus_Shrouded);
		AddEffectMessageToTrack(
			ActionMetadata,
			default.ShroudedEffectAcquiredString,
			VisualizeGameState.GetContext(),
			class'UIEventNoticesTactical'.default.ShroudedTitle,
			class'UIUtilities_Image'.const.UnitStatus_Shrouded,
			eUIState_Good);
		UpdateUnitFlag(ActionMetadata, VisualizeGameState.GetContext());
	}
}

static function ShroudedVisualizationRemoved(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult)
{
	local XComGameState_Unit UnitState;
	...
	AddEffectMessageToTrack(
		ActionMetadata,
		default.ShroudedEffectLostString,
		VisualizeGameState.GetContext(),
		class'UIEventNoticesTactical'.default.ShroudedTitle,
		class'UIUtilities_Image'.const.UnitStatus_Shrouded,
		eUIState_Bad);
...
static function AddImmuneFlyoverVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult, optional string LocFlyoverMsg = class'XLocalizedData'.default.UnitIsImmuneMsg)
{
	...
	if( EffectApplyResult == 'AA_UnitIsImmune' )
	{
		...
		if( AbilityContext != None )
		{
			...
			VisualizationMgr.GetNodesOfType( VisualizationMgr.BuildVisTree, class'X2Action_PlaySoundAndFlyOver', Nodes, ActionMetadata.VisualizeActor );
			for( ScanNodes = 0; ScanNodes < Nodes.Length; ++ScanNodes )
			{
				SoundAndFlyover = X2Action_PlaySoundAndFlyOver( Nodes[ScanNodes] );
				if( SoundAndFlyover != None &&
					SoundAndFlyover.FlyOverMessage == LocFlyoverMsg
					)
				{
					return;
				}
			}
			AddEffectSoundAndFlyOverToTrack( ActionMetadata, VisualizeGameState.GetContext(), LocFlyoverMsg, '', eColor_Good );
		}
	}
}
DefaultProperties
